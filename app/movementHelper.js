...
var MovementHelper = function(options)
{
  ...
  this.getEmptyActionsHitObject = function () {
    return {
      up : 0,
      down : 0,
      left : 0,
  ...
  this.actionsHit = this.getEmptyActionsHitObject();
  ...
  this.init = function()
  {
    ...
    {
      this.keys[i] = this.getInputKeyValue(this.keysStr[i]);
    };
  }

  this.getInputKeyIndex = function(key)
  {
    if(isNaN(key))
    {
    ...
    else return Math.min(Math.max(key, 0),this.actions.length);
  }

  this.updateKeyBinding = function(key, value)
  {
    var index = this.getInputKeyIndex(key);
    this.keys[index] = this.getInputKeyValue(value);
  }

  this.getInputKeyValue = function(value)
  {
    if(value.length == 1)
    {
    ...
    {
      return this.specialKeys.indexOf(value);
    }
  }
  ...
  {
    this.actions = this.getEmptyActionsObject();
    this.actions = this.getEmptyActionsHitObject();
  };
  this.left = function()
  {
  ...
  this.isHit = function(intKeyAction) //hit on 1, 61, 91, 121...
  {
    return (intKeyAction == 1) || (intKeyAction > settings.fps && ((intKeyAction-1) % (settings.fps/2) == 0));
  }
  this.leftHit = function()
  {
    return this.isHit(this.actionsHit.left);
  };
  this.AHit = function()
  {
    return this.isHit(this.actionsHit.A);
  };
  this.rightHit = function ()
  {
    return this.isHit(this.actionsHit.right);
  };
  this.upHit = function()
  {
    return this.isHit(this.actionsHit.up);
  };
  this.BHit = function()
  {
    return this.isHit(this.actionsHit.B);
  };
  this.downHit = function ()
  {
    return this.isHit(this.actionsHit.down);
  };
  this.StartHit = function()
  {
    return this.isHit(this.actionsHit.start);
  };
